---
title: 業務從業者專業認證
description: 瞭解如何獲得認證為Adobe [!DNL Audience Manager] 業務從業人員。
...
瞭解如何獲得認證 [!DNL Audience Manager] 業務從業人員。

## 最低體驗

您應對資料流、業務目標和KPI有基本的瞭解，並具備資料分析和策略方面的一些經驗
...
* 給定方案，生成報告以衡量激活或市場活動目標
* 給定方案，根據匹配率比較受眾

第四節：故障排除(10%)

* 給定方案，排除來自不同源類型和源類型的入站資料
* 驗證入站資料檔案的格式
...
第6節：配置檔案合併、ID同步和Audience Marketplace

* 將用戶特徵組織到單個統一的配置檔案中，以建立基於家庭或設備的受眾
* 使用Audience Marketplace識別激活
...
[查看示例問題](https://scorpion.caveon.com/launchpad/ad0-e458-adobe-audience-manager-business-practitioner-professional-copy-dvaivw){target="_blank"}

**第1節：段建立和協同內容**

* [將資料使用量批量上載到Audience Marketplace](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/audience-marketplace/buying-data/bulk-uploading-data-usage-into-the-audience-marketplace.html?lang=en){target="_blank"}
...
* [建立轉換特性 [!DNL Audience Manager]](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-conversion-traits.html?lang=en){target="_blank"}
...
* [GDPR就緒性指南 [!DNL Audience Manager] 客戶（資料控制器）](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-reference/aam-gdpr-readiness.html?lang=en){target="_blank"}
* [「段詳細資訊」頁](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/segments/segment-summary-view.html?lang=en){target="_blank"}
* [客戶提示 — 特點和細分最佳實踐](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/customer-tips-traits-and-segments-best-practices.html%3Flang%3Dja){target="_blank"}
...
* [Experience Platform分部共用 [!DNL Audience Manager] 和其他Experience Cloud解決方案](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.){target="_blank"}
...
* [管理資料源](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/data-sources/manage-datasources.html?lang=en){target="_blank"}
...
**第6節：配置檔案合併、ID同步和受眾市場**

* [配置檔案合併規則增強如何影響分段、激活和報告](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/profile-merge/how-profile-merge-rule-enhancements-impact-segmentation-activation-and-reporting.html?lang=en){target="_blank"}
* [建立轉換特性 [!DNL Audience Manager]](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-conversion-traits.html?lang=en){target="_blank"}
* [通過即席激活API按需激活受眾段以批處理目標](https://experienceleague.adobe.com/docs/experience-platform/destinations/api/ad-hoc-activation-api.html?lang=en){target="_blank"}
