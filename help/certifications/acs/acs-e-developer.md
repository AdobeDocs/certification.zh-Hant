---
title: 開發人員專家認證
description: 瞭解如何成為認證的Adobe Developer專家Adobe [!DNL Campaign Standard]。
...
* 在多渠道數字營銷活動和Web開發（如REST API）方面至少擁有兩年的相關經驗
* 能夠在Adobe Campaign執行包括模板開發、技術工作流、模式開發和整合在內的任務，並能夠使用控制面板監視實例
* 在渠道交付環境（電子郵件、直郵、移動和社交）中工作的體驗
* 熟悉多點觸控、生命週期和重新激活等營銷活動策略
* 瞭解市場營銷指標，如ROI、點擊率和轉換。
* 管理營銷自動化平台的經驗
* CSS、HTML和JavaScript的基本知識，電子郵件
* 關係資料庫基礎知識與資料建模
* 瞭解技術工作流並配置它們
* 擴展收件人表或方案和資料管理的經驗
* 已建立類型規則、工作流、交付和市場活動模板
* 配置的角色和權限
* 在管理控制台和與其他Adobe應用程式整合方面的經驗
* 對Adobe I/O和Adobe I/O Runtime的認識
* 在多渠道上處理事務性消息傳遞和消息傳遞方面的經驗
* 受管理的包的體驗
...
完成 [線上準備調查表](https://scorpion.caveon.com/launchpad/ad-q-e306-readiness-questionnaire-for-adobe-campaign-standard-developer-expert-exam){target="_blank"} 查看您當前的經驗是否與推薦的最低候選人資格相符。

**考試目標和範圍**

第1節：資料建模和管理(26%)

* 給定一個方案，將客戶端需求轉換為自定義資源
* 確定如何配置螢幕和篩選器定義
* 給定方案，確定定義鍵、索引和連結的正確策略
* 確定發佈資源更新的正確方法
* 排除資料建模問題
* 確定構建技術工作流的正確方法
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E306 newtab=true"}[!BADGE 示例]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E306 newtab=true"}
