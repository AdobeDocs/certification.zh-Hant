---
title: 開發人員專家認證
description: 了解如何成為經認證的Adobe Developer專家Adobe [!DNL Campaign Standard].
...
# 認證Adobe [!DNL Campaign Standard] 開發人員專家
...
* 了解行銷量度，例如投資報酬率、點進率和轉換。
* 管理行銷自動化平台的經驗
* CSS、HTML和JavaScript、電子郵件的基本知識
* 關係資料庫和資料建模的基本知識
* 了解技術工作流程並加以設定
* 擴充收件者表格或結構與資料管理的體驗
* 建立類型規則、工作流程、傳送和行銷活動範本
* 已設定的角色和權限
* 體驗管理主控台以及與其他Adobe應用程式的整合
* 對Adobe I/O和Adobe I/O Runtime的認識
* 在多通道上體驗交易式訊息傳送和訊息傳送
* 使用受管套件的體驗
...
完成 [線上準備問卷](https://scorpion.caveon.com/launchpad/ad-q-e306-readiness-questionnaire-for-adobe-campaign-standard-developer-expert-exam){target="_blank"} 來查看您目前的體驗是否符合建議的最低候選資格。

**考試目標和範圍**

第1節：資料建模和管理(26%)

* 在某種情況下，將客戶端需求轉換為自定義資源
* 決定如何設定螢幕和篩選定義
* 在情境中，請決定定義索引、索引和連結的正確策略
* 確定發佈資源更新的正確方法
* 疑難排解資料模型問題
* 確定建立技術工作流程的正確方法
...
* [建立自訂資源](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/creating-a-custom-resource.html?lang=en){target="_blank"}
...
* [設定自訂資源的螢幕定義](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/configuring-a-screen-definition-for-a-custom-resource.html?lang=en){target="_blank"}
* [設定畫面定義](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/configuring-the-screen-definition.html?lang=en){target="_blank"}
* [設定篩選器定義](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/configuring-filter-definition.html?lang=en){target="_blank"}
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E306 newtab=true"}[!BADGE 範例]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E306 newtab=true"}
