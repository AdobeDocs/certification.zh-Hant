---
title: 開發人員專家認證
description: 了解如何成為Adobe Developer的認證專家 [!DNL Campaign Classic].
...
* Campaign軟體體驗至少兩年
* 在JavaScript寫程式、SQL開發（包括ETL）和Web技術(XML、HTML和Web服務)方面至少擁有三年的綜合經驗
* 使用數位全通路執行行銷活動的體驗
* 資料庫架構與資料庫營銷知識
* 能將需求對應至Campaign功能
* 疑難排解Campaign實作
* 基本了解與Campaign相關的伺服器設定
...
完成 [線上準備問卷](https://scorpion.caveon.com/launchpad/ad-q-e129-readiness-questionnaire-for-adobe-aem-assets-developer-professional-exam-copy-21ocv4/ad-q-e312-readiness-questionnaire-adobe-campaign-classic-developer-expert-exam){target="_blank"} 來查看您目前的體驗是否符合建議的最低候選資格。
...
* 應用全系統配置設定和預設值
* 給定各種參數，選取適當的Adobe Campaign功能以實作使用案例
* 系統配置設定疑難排解
* 實作自訂設定
* 識別Campaign控制面板設定功能
...
* 在工作流程、SOAP呼叫、類型規則和個人化區塊中套用JavaScript程式庫
* 說明在Adobe中使用SQL函式的最佳實務 [!DNL Campaign Classic]
* 在案例中，了解如何在Adobe中使用SQL指令碼 [!DNL Campaign Classic]
* 描述常用的OOTB函式

第3節：訪問管理(8%)

* 在案例中，為運算子配置安全設定
* 說明如何根據解決方案設計檔案配置存取管理設定
* 使用Campaign控制面板描述存取管理
...
* 從Adobe Campaign外部，在結構上設定CRUD程式

第5節：執行個體維護(12%)

* 了解工作流程熱度圖並加以處理
* 示範建立自訂工作流程或報表以進行執行個體監控的程式
* 根據系統指標確定問題
* 說明服務和流程對系統的影響
* 演示基本的系統審核度量/檢查
...
* [Campaign FDA部署](https://experienceleague.adobe.com/docs/campaign/campaign-v8/config/architecture/ffda/enterprise-deployment.html?lang=en){target="_blank"}
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E330 newtab=true"}[!BADGE 範例]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E330 newtab=true"}
