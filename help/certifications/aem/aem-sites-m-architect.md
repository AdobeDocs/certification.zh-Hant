---
title: 架構師主證書
description: 瞭解如何成為Experience Manager Sites的認證建築師大師。
...
# 認證Adobe [!DNL Experience Manager Sites] 建築師大師
...
* 至少3年建築AEM Sites的建築師經驗
* 在Adobe Managed Services和Adobe中工作的能力 [!DNL Experience Manager as a Cloud Service]
* 設定Adobe [!DNL Experience Manager] 環境和基礎架構

此外，您應具備執行以下任務的能力：

* 為客戶設計軟體更改流程（在前和雲）
* 為內容/資產定義一個可適應未來需求的內容模型
* 根據業務需求定義必要的模板和元件
* 確定何時使用開箱即用/功能/核心元件而不是自定義元件
* 設計快取、負載平衡和安全策略（分發程式、防火牆、CDN）
* 為初始設定和功能交付提供高級工作量估計
* 建立國際化的功能與使用案例
* 定義支援多站點和多語言的策略
* 確定軟體模組的正確配置機制
...
* 瞭解部署方法（內容和代碼）
* 建立和提供基礎架構/部署圖
* 確定要與應用程式一起使用的信AEM息模型
* 定義身份驗證和授權安全模型和概念
* 根據客戶的要求（二進位儲存、部署方案等）確定持久性模型
* 為業務流程設計工作流模型
* 制定平台效能和滲透/安全測試策略
* 跨多個渠道重複使用內容
* 考慮以雲為重點的注意事項，例如：自動擴展、複製、資產管理、內部和托管服務之間的影響和差異、雲管理器、包管理
...
完成 [線上準備調查表](https://scorpion.caveon.com/launchpad/ad-q-e129-readiness-questionnaire-for-adobe-aem-assets-developer-professional-exam-copy-ycpz52/ad-q-e117-readiness-questionnaire-for-adobe-aem-architect-master-exam){target="_blank"} 查看您當前的經驗是否與推薦的最低候選人資格相符。
...
* 給定業務需求、設計詳細的體系結構和解決方案
* 給定一個方案，為設計確定適當的安全解決方案
* 應用過程性概念將整合要求納入解決方案設計
* 確定解決方案中應包括哪些類型的效能和測試要求
* 應用過程性概念來設計可擴展和彈性的體系結構
* 在情況下，建議遷移策略

第三節：執行(22%)

* 給定一個方案，確定並解決在實施階段發現的設計問題
* 在設想的情況下，根據要求建議實施辦法
* 確定用於原型解決方案以驗證概念的適當方法
* 給定方案，診斷並解決實施過程中遇到的問題

第四節：維護(16%)

* 給定一個方案，診斷並解決生產環境中遇到的問題
* 應用程式概念規劃新功能和升級的使用
* 給定一個方案，針對非功能性需求優化解決方案
...
[查看示例問題](https://scorpion.caveon.com/launchpad/ad-q-e129-readiness-questionnaire-for-adobe-aem-assets-developer-professional-exam-copy-ycpz52/ad-q-e117-readiness-questionnaire-for-adobe-aem-architect-master-exam){target="_blank"}
...
* [作為AEM雲服務的介紹](http://www.jetteroheller.com/introducing-aem-as-a-cloud-service/){target="_blank"}
...
* [AEM Assets視頻和教程](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/overview.html?lang=en){target="_blank"}
* [SPA/SEO:Google第1頁單頁應用指南](https://snipcart.com/spa-seo){target="_blank"}
* [Sling上下文感知配置](https://cqdump.wordpress.com/2018/04/24/sling-context-aware-configuration/){target="_blank"}
* [會議演講：Sling上下文感知配置](https://adapt.to/2016/en/schedule/sling-context-aware-configuration.html){target="_blank"}
* [AEM Sites視頻和教程](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/overview.html?lang=en){target="_blank"}
* [如何根據6.4中的模板顯示/隱AEM藏頁面屬性](https://blogs.perficient.com/2019/01/03/how-to-show-hide-page-properties-based-on-page-template-in-aem-6-4/){target="_blank"}
* [花崗岩AEM自定義渲染條件](http://www.nateyolles.com/blog/2016/07/aem-granite-custom-render-conditions){target="_blank"}
* [在反應應用程式中防止XSS](https://dev.to/spukas/preventing-xss-in-react-applications-5f5j){target="_blank"}
...
* [AEM Sites視頻和教程](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/overview.html?lang=en){target="_blank"}
* [AEM Screens最佳做法](https://experienceleague.adobe.com/docs/experience-manager-screens/using/about-guide.html?lang=en){target="_blank"}
* [Adobe幫助文檔](https://helpx.adobe.com/tw/enterprise/using/adobe-asset-link.html){target="_blank"}
* [6AEM.5Forms指南](https://experienceleague.adobe.com/docs/experience-manager-65/forms/home.html?lang=en){target="_blank"}
* [AEM 6.5 管理使用指南](https://experienceleague.adobe.com/docs/experience-manager-65/administering/home.html?lang=en){target="_blank"}
...
* [如何在中清除Dispatcher緩AEM存](https://www.axamit.com/blog/adobe/dispatcher-4#:~:text=At%20the%20low%20level%20dispatcher,the%20root%20of%20htdocs%20directory.){target="_blank"}
* [AEM Cloud Service調度器轉換器](https://github.com/adobe/aem-cloud-service-dispatcher-converter){target="_blank"}
...
* [Adobe [!DNL Experience Manager] 案頭應用概述](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/introduction.html?lang=en){target="_blank"}
...
* [Adobe Admin Console上的身份類型](https://helpx.adobe.com/ca/enterprise/using/identity.html){target="_blank"}
* [Dispatcher 總覽](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/dispatcher.html?lang=en){target="_blank"}
...
* [AEM 6.5 管理使用指南](https://experienceleague.adobe.com/docs/experience-manager-65/administering/home.html?lang=en){target="_blank"}
* [Oak TarMK記憶體映射檔案](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/oak-tarmk-memory-mapped-files/td-p/218220){target="_blank"}
* [Dispatcher 總覽](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/dispatcher.html?lang=en){target="_blank"}
...
* [搜AEM索與搜索](https://blog.3sharecorp.com/aem-search-vs。-solr搜索){target="_blank"}
...
* [Cloud Manager 簡介](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/introduction.html?lang=zh-Hant){target="_blank"}
* [雲管理器：入門](https://developer.adobe.com/experience-cloud/cloud-manager/guides/getting-started/){target="_blank"}
* [CQBufferedImageCache在資產上載期間消耗堆](https://helpx.adobe.com/experience-manager/kb/cqbufferedimagecache-consumes-heap-during-asset-uploads.html){target="_blank"}
* [Assets 指南](https://experienceleague.adobe.com/docs/experience-manager-65/assets/home.html?lang=en){target="_blank"}
