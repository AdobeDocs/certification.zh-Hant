...
source-git-commit: dbc43f993877198150f70d864562ce223027fc5d
workflow-type: tm+mt
...
+ 技術認證（依解決方案） {#technical-certifications}
   ...
   + Adobe [!DNL Marketo Engage] {#ame}
      ...
      + 主版 {#ame-master}
         ...
         + [架構者 — 新](/help/certifications/ame/ame-m-architect-23-08.md)
   ...
   + Adobe [!DNL Workfront] {#aw}
      ...
      + 專家 {#aw-expert}
         ...
         + [開發人員（核心） — 最新](/help/certifications/aw/aw-core-e-developer-23-08.md)
