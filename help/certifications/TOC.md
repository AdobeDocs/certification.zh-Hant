---
user-guide-title: 認證Adobe
breadcrumb-title: 認證Adobe
user-guide-description: 了解 [!DNL Experience Cloud] Adobe認證。 了解獲得認證對您有什麼幫助。
...
+ [我的設定檔](my-profile.md)
+ [常見問題集](faq.md)
+ 技術認證 {#technical-certifications}
   + Adobe [!DNL Advertising] {#aac}
      + 專業 {#aac-professional}
         + [業務從業人員（搜索）](/help/certifications/aac/aac-search-p-business.md)
   ...
   + Adobe [!DNL Experience Manager] {#aem}
      ...
      + 主版 {#aem-master}
         + [架構師（站點）](/help/certifications/aem/aem-sites-m-archtiect.md)
      + [續約](/help/certifications/aem/aem-renew.md)
   + Adobe [!DNL Marketo Engage] {#ame}
      + 專業 {#ame-professional}
         + [認證專業人員](/help/certifications/ame/ame-p.md)
      + 專家 {#ame-expert}
   ...
   + Adobe [!DNL Doc Cloud] {#adc}
      + 專業 {#adc-professional}
         + [商業從業人員](/help/certifications/adc/adc-professional.md)
...
+ 隱藏 {#hidden}
   + [認證重新啟動資格考試檢查程式](exam-eligibility-check.md)
