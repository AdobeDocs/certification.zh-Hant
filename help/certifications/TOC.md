...
user-guide-description: 了解 [!DNL Experience Cloud] Adobe認證。 了解獲得認證能為您做什麼。
...
+ 按解決方案列出的技術認證 {#technical-certifications}
   + Adobe [!DNL Advertising] {#aac}
      + [廣告概觀](/help/certifications/aac/aac-overview.md)
      + 專業 {#aac-professional}
   ...
   + Adobe [!DNL Commerce] {#ac}
      + [商務概述](/help/certifications/ac/ac-overview.md)
      + 專業 {#ac-professional}
