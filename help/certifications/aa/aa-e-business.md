...
>[!NOTE]
>
>**可用的新研究資源：** 此 [考試準備指南](https://app.rockinfo.com/courses/playScorm/533) 提供量身打造的認證測試準備流程，包括成功取得此認證所需的資料。 _如果系統提示您登入「備考指南」，請使用您的Adobe ID。_
...
* 套用流程以排程專案和Data Warehouse
* 套用程式，為不同的使用者和/或群組共用專案和Reporting and Analytics儀表板
* 套用處理以設定警示
* 套用程式以查詢維度/元件
* 套用程式以建立視覺效果
* 指定情境，決定要使用的適當專案
