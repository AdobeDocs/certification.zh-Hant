...
>[!NOTE]
>
>這是最新的Adobe Commerce前端開發人員專業測驗。 如果您已開始學習或排程 [較舊版本](ac-p-fedeveloper.md) 您必須在2023年8月18日之前完成。

## 最低體驗

您應該擁有0至12個月的Adobe Commerce前端開發實踐經驗，並有能力使用技術解決方案來提供個別元件。
...
* [常見自訂任務](https://developer.adobe.com/commerce/frontend-core/guide/layouts/xml-manage/){target="_blank"}
...
* [可觀察專案(DockOutJS)](https://knockoutjs.com/documentation/observables.html){target="_blank"}
...
[!BADGE 測驗]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E721 newtab=true"}
