---
title: 商務從業者專家認證
description: 瞭解如何成為Adobe領域的Adobe商業從業者專家 [!DNL Commerce].
solution: Commerce
product: Magento
role: User
level: Experienced
...
>[!NOTE]
>
>**可用的新研究資源：** 此 [考試準備指南](https://app.rockinfo.com/courses/playScorm/386) 提供量身打造的認證測試準備流程，包括成功取得此認證所需的資料。 _如果系統提示您登入「備考指南」，請使用您的Adobe ID。_
