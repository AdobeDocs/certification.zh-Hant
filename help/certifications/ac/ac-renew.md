---
title: 認證續約
description: 瞭解如何更新Adobe [!DNL Commerce] 認證過期之前。
solution: Commerce
product: Magento
...
* 可用語言：英文
* 費用：免費
* 考試ID：AD5-E840Adobe [!DNL Commerce] 商務從業者專業更新考試
...
* [為購物者提供協助](https://experienceleague.adobe.com/docs/commerce-admin/customers/customer-accounts/manage/login-as-customer.html){target="_blank"}
* [內容分段](https://experienceleague.adobe.com/docs/commerce-admin/content-design/staging/content-staging.html){target="_blank"}
...
* 可用語言：英文
* 費用：免費
* 考試ID：AD5-E839Adobe [!DNL Commerce] 開發人員專業版
...
* [新增管理格線](https://developer.adobe.com/commerce/php/development/components/add-admin-grid/){target="_blank"}
...
* [URL重新寫入](https://experienceleague.adobe.com/docs/commerce-admin/marketing/seo/url-rewrites/url-rewrite.html){target="_blank"}
...
* [相依性插入設定](https://developer.adobe.com/commerce/php/development/build/dependency-injection-file/){target="_blank"}
...
* [設定宣告式綱要](https://developer.adobe.com/commerce/php/development/components/declarative-schema/configuration/){target="_blank"}
...
* [購物車設定](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/point-of-purchase/cart/cart-configuration.html){target="_blank"}
...
首先，選取 **兩個課程** 完成及通過每個課程評估，分數為80%或以上。 課程評量是免費、隨選、非監督及公開的。 您可以重複這些課程，直到成功通過80%的評量為止。
  ...
  [客戶參考表 [!DNL Adobe Commerce]](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA700){target="_blank"}
...
| [Adobe [!DNL Commerce] 個人化](https://experienceleague.adobe.com/docs/commerce-events/events/commerce-and-coffee/2022/personalization.html){target="_blank"} | [ADR-EA704](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA704){target="_blank"} |
...
| [[!DNL Commerce]：與Experience Platform及其他專案的資料整合](https://video.tv.adobe.com/v/3413334/){target="_blank"} | [ADR-EA709](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA709){target="_blank"} |
| [[!DNL Commerce]：Adobe上的可組合Commerce [!DNL Commerce]](https://video.tv.adobe.com/v/3413335/){target="_blank"} | [ADR-EA710](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA710){target="_blank"} |
