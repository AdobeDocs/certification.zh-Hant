...
>[!NOTE]
>
>這是最新的 [!DNL Adobe Commerce] 前端開發人員專家考試。 如果您已開始學習或已排程 [較舊版本](ac-e-fedeveloper.md) 您必須在2023年8月18日之前完成。

## 最低體驗

此 [!DNL Adobe Commerce] Frontend Developer被視為專家級角色，在Adobe Commerce Frontend開發方面至少擁有1至3年的實踐經驗。 他們應該有能力將工作需求所表達的需求轉換成技術解決方案。
...
* 區別部署模式的適當使用案例
* 定義群組設定及使用方式
* 說明Cloud提供的其他工具（Fastly、下載資料庫、內容部署、使用UI分支）
