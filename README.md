...
請參閱 [Adobe Docs 貢獻者指南](https://docs.adobe.com/content/help/certifications/en/contributor/contributor-guide/introduction.html)。

貢獻方式取決於您的身分和您要提交的變更類型：

### 微幅變更

若您出於好意想貢獻微幅更新內容，請前往文章，按一下文章中的&#x200B;**編輯**&#x200B;連結，隨即會轉至該文章的 GitHub 來源，然後只需使用 GitHub UI 進行更新。 如需詳細資訊，請參閱一般 [Adobe Docs 貢獻者指南](https://docs.adobe.com/content/help/certifications/en/contributor/contributor-guide/introduction.html)。
...
如需詳細資訊，請參閱 [Adobe Docs 貢獻者指南](https://docs.adobe.com/content/help/certifications/en/contributor/contributor-guide/introduction.html)。
